...
# This is for the binary classification problem if you set `from_logits=False` 
#when declaring the loss. With this, you will also not need to call the `tf.math.sigmoid()` 
#function in the loop because the model output is already a probability
